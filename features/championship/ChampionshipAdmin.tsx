                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="relative" ref={exportMenuRef}>
                      <button
                        ...
                        className="px-3.5 py-2 bg-white hover:bg-slate-50 border border-slate-200 text-slate-800 font-bold text-xs uppercase tracking-wider rounded-xl transition-all flex items-center gap-1.5 cursor-pointer shadow-2xs"
                        title="Turnierergebnisse exportieren oder drucken"
                      >
                      ...
                      {isExportMenuOpen && (
                        <div className="absolute right-0 top-full mt-1.5 w-64 bg-white rounded-xl shadow-xl border border-slate-200 p-1.5 z-50 animate-in fade-in zoom-in-95 duration-100">
                          ...
                          <button
                            ...
                            onClick={() => {
                              setIsExportMenuOpen(false);
                              exportChampionshipToPdf(currentTournament, users, clubName);
                            }}
                          ...
                          <button
                            ...
                            onClick={() => {
                              setIsExportMenuOpen(false);
                              exportChampionshipToExcel(currentTournament, users, clubName);
                            }}
                          ...
                          >
                            ...
                            <div className="min-w-0">
                              ...
                              <span className="text-[10px] text-slate-400 block truncate">
                                DIN A4 Bericht über Browser drucken
                              </span>
                            </div>
                          </button>
                        </div>
